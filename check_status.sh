...
PREVIEW_FRONTEND=$(curl -s https://smooth-form-persist.preview.emergentagent.com/ 2>&1 | grep -o "Pinspire")
...
PREVIEW_BACKEND=$(curl -s https://smooth-form-persist.preview.emergentagent.com/api/auth/login \
...
echo ""
echo "🌐 Access:"
echo "  https://smooth-form-persist.preview.emergentagent.com"
echo ""
