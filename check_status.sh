...
PREVIEW_FRONTEND=$(curl -s https://codebase-review-43.preview.emergentagent.com/ 2>&1 | grep -o "Pinspire")
...
PREVIEW_BACKEND=$(curl -s https://codebase-review-43.preview.emergentagent.com/api/auth/login \
