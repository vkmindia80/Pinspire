...
PREVIEW_FRONTEND=$(curl -s https://connect-git.preview.emergentagent.com/ 2>&1 | grep -o "Pinspire")
...
PREVIEW_BACKEND=$(curl -s https://connect-git.preview.emergentagent.com/api/auth/login \
...
echo ""
echo "🌐 Access:"
echo "  https://connect-git.preview.emergentagent.com"
echo ""
