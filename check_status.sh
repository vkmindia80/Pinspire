...
PREVIEW_FRONTEND=$(curl -s https://codebase-cleaner.preview.emergentagent.com/ 2>&1 | grep -o "Pinspire")
...
PREVIEW_BACKEND=$(curl -s https://codebase-cleaner.preview.emergentagent.com/api/auth/login \
...
echo ""
echo "🌐 Access:"
echo "  https://codebase-cleaner.preview.emergentagent.com"
echo ""
